...
import BarVariant from "./bar-chart";
...
const VisitorMonthlyCharts = ({ data = [] }: Props) => {
    ...
    if (!data || !isVisible) return <ChartLoading />
    ...
    return (
        <Card className=" border-none  " >
            <CardHeader className=" flex space-y-2 lg:space-y-0 lg:flex-row lg:items-center justify-between " >
                <CardHeader>
                    <CardTitle>Monthly visitor overview</CardTitle>
                </CardHeader>
                <Select
...
export default VisitorMonthlyCharts
